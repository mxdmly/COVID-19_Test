...
<%! 
	...
	String id_str, name_str, isUpload_str, idNum_str, samplingTime, phoneNum_str;
...
<%
	...
	*/
	try{
		...
		String sql_str = "SELECT ID, name, isUpload, idNum, phoneNum, testResult, samplingTime FROM dbo._COVID19test WHERE isUpload = 0 ORDER BY dbo._COVID19test.ID DESC";
		...
		while(rs.next()){
			if(rs.getString("samplingTime") != null){
				...
				phoneNum_str = rs.getString("phoneNum");//手机号
